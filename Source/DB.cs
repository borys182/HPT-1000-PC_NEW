...
namespace HPT1000.Source
{
    ...
    class DB
    {
        ...
        public DB()
        {
            ...
            aErrorText = new ErrorText((int)Types.ERROR_CATEGORY.MX_COMPONENTS, (int)Types.ERROR_CODE.SET_FLOW, 0, "Nie moge ustawic przeplywu. MX Components zglasza blad: ", Types.Language.English);
            errorsTextList.Add(aErrorText);

            aErrorText = new ErrorText((int)Types.ERROR_CATEGORY.MX_COMPONENTS, (int)Types.ERROR_CODE.SET_MAX_FLOW, 0, "Nie moge ustawic max przeplywu. MX Components zglasza blad: ", Types.Language.English);
            errorsTextList.Add(aErrorText);

            aErrorText = new ErrorText((int)Types.ERROR_CATEGORY.MX_COMPONENTS, (int)Types.ERROR_CODE.SET_RANGE_VOLTAGE_MFC, 0, "Nie moge ustawic zakresu napiec dla przeplywki. MX Components zglasza blad: ", Types.Language.English);
            errorsTextList.Add(aErrorText);

            aErrorText = new ErrorText((int)Types.ERROR_CATEGORY.MX_COMPONENTS, (int)Types.ERROR_CODE.SET_TIME_FLOW_STABILITY, 0, "Nie moge ustawic czasu stabilizacji przeplywu przeplywki. MX Components zglasza blad: ", Types.Language.English);
            errorsTextList.Add(aErrorText);

            aErrorText = new ErrorText((int)Types.ERROR_CATEGORY.MX_COMPONENTS, (int)Types.ERROR_CODE.START_PROGRAM, 0, "Nie mofe uruchomic programu. MX Components zglasza blad: ", Types.Language.English);
            errorsTextList.Add(aErrorText);

            aErrorText = new ErrorText((int)Types.ERROR_CATEGORY.MX_COMPONENTS, (int)Types.ERROR_CODE.STOP_PROGRAM, 0, "Nie moge zatrzymac programu. MX Components zglasza blad: ", Types.Language.English);
            errorsTextList.Add(aErrorText);

            aErrorText = new ErrorText((int)Types.ERROR_CATEGORY.MX_COMPONENTS, (int)Types.ERROR_CODE.UPDATE_SETINGS, 0, "Nie moge zaktualizowac ustawien urzadzen PLC. MX Components zglasza blad: ", Types.Language.English);
            errorsTextList.Add(aErrorText);

            aErrorText = new ErrorText((int)Types.ERROR_CATEGORY.MX_COMPONENTS, (int)Types.ERROR_CODE.WRITE_PROGRAM, 0, "Nie moge zaladowac programu do PLC. MX Components zglasza blad: ", Types.Language.English);
            errorsTextList.Add(aErrorText);
