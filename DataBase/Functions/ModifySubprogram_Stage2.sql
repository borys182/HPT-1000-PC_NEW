-- Function: public."ModifySubprogramStages_2"(integer, boolean, boolean, boolean, boolean, real, real, real, real, real, real, real, real, real, real, real, real, real, real, real, real, real, real, real, real, time without time zone, integer, integer, integer, integer)

-- DROP FUNCTION public."ModifySubprogramStages_2"(integer, boolean, boolean, boolean, boolean, real, real, real, real, real, real, real, real, real, real, real, real, real, real, real, real, real, real, real, real, time without time zone, integer, integer, integer, integer);
...
$BODY$DECLARE
  ...
  BEGIN
	...
	mfc1_id_gas_type = mfc1_id_type_gas , mfc2_id_gas_type = mfc2_id_type_gas , mfc3_id_gas_type = mfc3_id_type_gas
  ...
  COST 100;
ALTER FUNCTION public."ModifySubprogramStages_2"(integer, boolean, boolean, boolean, boolean, real, real, real, real, real, real, real, real, real, real, real, real, real, real, real, real, real, real, real, real, time without time zone, integer, integer, integer, integer)
  OWNER TO postgres;
